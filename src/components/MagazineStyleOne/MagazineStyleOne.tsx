                ...
                <div className="col-12 pb-5">
                    <section className="row">
                        <div className="col-12 col-md-6 pb-0 pb-md-3 pt-2 pr-md-1">
                            ...
                            <Carousel>
                                {MagazineStyleOneCarouselContent.map((item) =>
                                    <Carousel.Item>
                                        <img
                                        ...
                                        />
                                        <Carousel.Caption>
                                            <h6 className="text-white font-weight-bold">{item.title}</h6>
                                            <p>{item.caption}</p>
                                        </Carousel.Caption>
                                    </Carousel.Item>
                                )}
                        ...
                        <div className="col-12 col-md-6 pt-2 pl-md-1 mb-3 mb-lg-4">
                            <div className="row">
                                ...
                                {MagazineStyleOneContent.map((item) =>
                                        ...
                                        <div className="card border-0 rounded-0 text-white overflow zoom">
                                            <div className="position-relative">
                                                ...
                                                <div className="position-absolute p-2 p-lg-3 b-0 w-100 bg-shadow">
                                                    <a className="p-1 badge badge-secondary-lynne rounded-0"
                                                       href="#">
                                                        {item.tag}
                                                    </a>
